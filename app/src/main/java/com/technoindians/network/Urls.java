...
//http://technoindians.com/
    ...
    public static final String POST_OPERATIONS_URL = "post_operations.php";
    public static final String FOLLOWER_OPERATIONS = "follower_operations.php";
    public static final String MESSAGE_OPERATIONS = "message_operations.php";
    public static final String UPLOAD_IMAGE = "file_upload.php" ;
